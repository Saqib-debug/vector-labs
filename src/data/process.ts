...
export const processSteps: ProcessStep[] = [
  {
    num: "01",
    title: "Diagnose",
    description: "We audit your clinic’s current digital position, funnel friction, and growth bottlenecks.",
    deliverable: "A diagnosis of what is weakening trust, visibility, or booking flow.",
    whyItMatters: "You should know what is actually holding back growth before spending on redesign or ads.",
  },
  {
    num: "02",
    title: "Strategy",
    description: "We map the clinic growth system around services, traffic sources, trust signals, and conversion steps.",
  ...
  },
  {
    num: "03",
    title: "Design",
    description: "We design the visual and UX system that makes the clinic feel premium, clear, and easy to trust.",
    deliverable: "High-fidelity page direction, visual identity cues, and page-by-page UX.",
    whyItMatters: "For clinics, perceived quality and trust directly shape consultation intent.",
  },
  {
    num: "04",
    title: "Build",
  ...
  },
  {
    ...
    deliverable: "A launched site with checked booking paths, tracking, and operational handoff.",
  ...
  },
  {
    ...
    whyItMatters: "The strongest clinic sites keep improving after launch instead of standing still.",
    isHighlight: true,
  },
];
